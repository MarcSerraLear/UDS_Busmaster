...
HRESULT CDIL_CAN_ICSNeoVI::CAN_ListHwInterfaces(INTERFACE_HW_LIST& asSelHwInterface, INT& nCount)
{
    ...
    {
        sg_pIlog->vLogAMessage(A2T(__FILE__), __LINE__, "Error in getting driver status");
    }
    return hResult;
}
...
HRESULT CDIL_CAN_ICSNeoVI::CAN_SelectHwInterface(const INTERFACE_HW_LIST& asSelHwInterface, INT /*nCount*/)
{
    ...
    {
        hResult = S_FALSE;
        sg_pIlog->vLogAMessage(A2T(__FILE__), __LINE__, "Driver is not running...");
    }
    return hResult;
}
...
HRESULT CDIL_CAN_ICSNeoVI::CAN_StartHardware(void)
{
    ...
    if (hResult == S_OK)
    {
        ...
        {
            sg_pIlog->vLogAMessage(A2T(__FILE__), __LINE__, "Could not start the read thread" );
        }
    }
...
HRESULT CDIL_CAN_ICSNeoVI::CAN_LoadDriverLibrary(void)
{
    ...
    if (sg_hDll != NULL)
    {
        sg_pIlog->vLogAMessage(A2T(__FILE__), __LINE__, "icsneo40.dll already loaded");
    ...
    if (S_OK == hResult)
    {
        ...
        if (sg_hDll == NULL)
        {
            sg_pIlog->vLogAMessage(A2T(__FILE__), __LINE__, "icsneo40.dll loading failed");
