...
CPanel::CPanel(CWnd* pParent /*=NULL*/,CMainPanel* pMP)
...
**********************************************************************************************************/
void CPanel::vInitializePanelFields(){
...
void CPanel::PrepareData(){
		UpdateData();	
		valueMileCouFtMotbk2010 = (int)(editMileCouFtMotbk2010.fGetValue()*8);
		valueMileCouRrMotbk2010 = (int)(editMileCouRrMotbk2010.fGetValue()*8);
		...
		valueVWhlFtMotbk2010 = editVWhlFtMotbk2010.lGetValue();
		valueVWhlRrMotbk2010 = editVWhlRrMotbk2010.lGetValue();
...
void CPanel::UpdateAlive(){
	...
	if(flagCrcVMotbk2010){
		...
		SPEED_MSG_DATA[0] = (0x0F & valueAlivVMotbk2010) + (0x00F & valueVWhlRrMotbk2010) * 16;
		SPEED_MSG_DATA[1] = (0xFF0 & valueVWhlRrMotbk2010) / 16;
		SPEED_MSG_DATA[2] = 0x0FF & valueVWhlFtMotbk2010;
		SPEED_MSG_DATA[3] = valueStBrkFtMotbk2010 * 64 + valueStBrkRrMotbk2010 * 16 + (0xF00 & valueVWhlFtMotbk2010) / 256;
		SPEED_MSG_DATA[4] = valueStAbsMotbk2010 * 16 + valueStSenVFtMotbk2010 * 4 + valueStSenVRrMotbk2010;
		SPEED_MSG_DATA[5] = valueStStassMotbk2010 * 32 + valueModVehAbsChovMotbk2010 * 8 + valueModVehAbsAcvMotbk2010;
		SPEED_MSG_DATA[6] = valueStModTltMotbk2010 * 4 + valueStIlkTltMotbk2010;

		crc = 0;
		crc = CrcTable8[crc ^ (byte)(ApplicationId & 0x00ff)];
		crc = CrcTable8[crc ^ (byte)(ApplicationId >> 8)];
		for (count = 0; count < 7; count++){
			crc = CrcTable8[crc ^ SPEED_MSG_DATA[count]];
		}
		valueCrcVMotbk2010 = crc;
		editCrcVMotbk2010.vSetValue(valueCrcVMotbk2010);
		UpdateData(false);
	}
